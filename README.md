...
In this repo you'll see how to build and deploy an AI-Powered Agent Diet Planner. For UI using Streamlit, LLM model using Ollama, Duckdb for store data and docker container deployment.

Through the codelab, you will employ a step by step approach as follows:

* Prepare your project.
* Build Agentic AI Diet Planner using streamlit, Google ADK and Duckdb
...
docker run --gpus all -p 8080:8080 -p 11434:11434 streamlit-ollama
```
